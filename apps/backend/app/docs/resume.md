...
## Profile
Adnan Ahmed Bhameshan is a Full Stack Engineer and AI Developer building toward international software engineering opportunities.

He is strongest when working across product UI, backend APIs, databases, and AI/NLP integrations. His portfolio emphasizes complete systems rather than isolated UI demos.
...
## Availability
Adnan is open to international opportunities and remote roles.

TODO_VERIFY:
Add current location, resume PDF URL, education timeline, and work history once verified.
