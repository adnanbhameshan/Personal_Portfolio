...
## Frontend
Verified frontend technologies used across the portfolio include React, TypeScript, Vite, and Tailwind CSS.

## Backend
Verified backend technologies include Node.js, Express.js, FastAPI, Sequelize, and server-rendered EJS.

Trackr uses Node.js and Express.js for its main application backend and a separate FastAPI service for NLP processing. It also uses Mongoose, JWT, bcryptjs, CORS, Cookie-parser, and Nodemailer.
...
## AI and NLP
Trackr uses Python, TF-IDF Vectorization, and Cosine Similarity for resume-to-job-description comparison.
